...
function osmPointStyleFn(feature) {
  ...
  const defs = {
    pin: `${BASE_URL}icons/pin.png`,
    tee: `${BASE_URL}icons/tee.png`,
  };
...
const btnRecintoLayer = makeVectorLayer({
  source: makeGeoJsonSource(`${BASE_URL}data/BTN_Recinto_CampoGolf.geojson`),
  visible: false,
...
const btnZonasVerdesLayer = makeVectorLayer({
  source: makeGeoJsonSource(`${BASE_URL}data/BTN_ZonasVerdes_CamposGolf_T2.geojson`),
  visible: false,
...
const osmAreaLayer = makeVectorLayer({
  source: makeGeoJsonSource(`${BASE_URL}data/OSM_Area.geojson`),
  visible: false,
...
const osmLineLayer = makeVectorLayer({
  source: makeGeoJsonSource(`${BASE_URL}data/OSM_Line.geojson`),
  visible: false,
...
const osmPointLayer = makeVectorLayer({
  source: makeGeoJsonSource(`${BASE_URL}data/OSM_Point.geojson`),
  visible: false,
